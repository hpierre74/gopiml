...
func detectFaces(w io.Writer, file string) error {
	...
	if len(annotations) == 0 {
		...
		for i, annotation := range annotations {
			...
			fmt.Fprint(w, annotation.BoundingPoly)
			fmt.Fprintln(w, reflect.TypeOf(annotation.BoundingPoly))
...
// x:729 y:141 > vertices:<x:859 y:141 > vertices:<x:859 y:293 > vertices:<x:729 y:293

// l 729 r 859 = 130px
// t 193 b 293 = 100px
// convert -crop 130x100+729+193  upload2.jpg  final.jpg
